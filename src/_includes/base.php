    ...
    <body class="w3-black">
        ...
        <footer>
            <div class="w3-content w3-padding w3-text-gray w3-center w3-small">
                <p>Copyright &copy; <a href="https://angelicahenderson.echoverse.cc" target="_blank">Angelica Henderson</a>.</p>
                <p class="w3-opacity">Site by <a href="https://paulawhitefield.echoverse.cc" target="_blank"><b>Paula Whitefield</b></a>.</p>
            </div>
        </footer>
    </body>
</html>
